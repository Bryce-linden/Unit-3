...
function setChart(csvData, colorScale){
    ...
    var axis1 = chart.append("g")
     ...
     var bars = chart.selectAll(".bars")
        ...
        .attr("class", function(d){
            return "bars " + d.NAME; //change to county from the .adm in example. Setting it to NAME or countiesZ highlights all bars
        })
...
function updateChart(bars, n, colorScale) {
    ...
    function setLabel(props) {
        ...
        var infolabel = d3
            ...
            .html(labelAttribute);
        //commenting out regionName removes the name label over the map!
       var regionName = infolabel.append("div").attr("class", "labelname").html(props.NAME);
       //.html("<h1><b>") + props.NAME + " County"+"</b></h1>"
    }
